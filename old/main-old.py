...
from fhboost import HolensteinBoostClassifier
...
times = []
all_scores = []
classifiers = [HolensteinBoostClassifier(max_depth=MAX_TREE_DEPTH),
...
ax.set_title('Cross-Validation Performance of boosting models on Breast Cancer Dataset', fontsize=20)
